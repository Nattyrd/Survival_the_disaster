 ...
 * Archivo: Mission1_Boss1.js | Clase exportada: Boss1 | Manifest: boss1
 *
 * ⚠ Única implementación de Boss1 (Boss1.js legacy fue eliminado).
 * GameScene.createMission1() instancia: new Boss1(scene, x, y)
 *
  ...
  spawnProjectile(type, player, stats) {
    ...
    try {
      if (this.scene.sound) {
        ...
        this.scene.sound.play(randomSound, { volume: 0.6 });
      }
    } catch (e) {
